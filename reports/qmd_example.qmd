...
We present the standard deviations in @tbl-horse-pop.
...
Additionally, note that in @tbl-horse-pop we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-pops.

![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-horse-largest-sd width=65%}

In @fig-horse-largest-sd we zoom in and look at the province of `{R} largest_sd`, whic h had the largest spread of values in terms of standard deviation.
